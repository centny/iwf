...
{
	UITreeIconView *view = [[UITreeIconView alloc] initWithFrame:frame];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
	...
	if ([_delegatetvd isParentNode:sobj]) {
		...
		if ([self checkRemoveSubtree:(int)indexPath.row]) {
			return;
		}
...
{
	int idx = (int)[_data indexOfObject:subtree.parentObj];
