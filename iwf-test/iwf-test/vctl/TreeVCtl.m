...
-(UIView*)cellView:(UITreeView*)tree sobj:(NSDictionary *)sobj cell:(UITableViewCell *)cell{
    UILabel *label=[[UILabel alloc]initWithFrame:CGRectMake(0, 15, 100, 20)];
...
-(UIView*)headerView:(NSDictionary*)parent tree:(UIPushTreeView *)tree{
    UILineView *view=[[UILineView alloc]initWithFrame:CGRectMake(0, 0, FRAM_W(self.view), PTV_HEADER_H)];
